...
def export_data_clustering(G, t, file_path):
    '''
    nx.Grpah * dictBT * str -> None
    Writes in file_path the data about the network G
    '''
...
def main_network(query, numerical_variables, file_path):
    '''
    str * List[str] -> None
    ...
    export_data_clustering(G, t, file_path)
